...
@section('title', 'Perusahaan Klien')
...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-muted">Perusahaan Klien</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
    ...
    <script>
        $(document).ready(function() {
            ...
            let table = $('#datatable').DataTable({
                ...
                ajax: {
                    ...
                    url: '{{ route("dashboard-admin.management-user.company.index") }}',
                    type: 'GET',
...

                    {
                        ...
                        render: function(data){
                            ...
                            return `
                                ...
                                <a href="/dashboard-admin/management-user/company/${data.uuid}"
        ...
        $('#btnSubmitVerify').click(function(){
            ...
            $.ajax({
                ...
                url:'/dashboard-admin/management-user/company/'+uuid+'/verify',
        ...
        $('#btnSubmitStatus').click(function(){
            ...
            $.ajax({
                ...
                url: '/dashboard-admin/management-user/company/' + uuid + '/status',
