...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-muted">Bidang Usaha</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
...
@section('content')
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="deleteModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Hapus Bidang Usaha</h5>
    ...
    <script>
        $(document).ready(function() {
            ...
            let table = $('#datatable').DataTable({
                ...
                ajax: {
                    ...
                    url: '{{ route("dashboard-admin.master.industry.index") }}',
                    type: 'GET',
        ...
        $("#formCreate").submit(function(e){
            ...
            $.ajax({
                ...
                url:"{{ route('dashboard-admin.master.industry.store') }}",
        ...
        $("#formEdit").submit(function(e){
            ...
            $.ajax({
                ...
                url:"{{ route('dashboard-admin.master.industry.index') }}/"+uuid,
