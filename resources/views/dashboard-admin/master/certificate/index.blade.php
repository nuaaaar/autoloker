    ...
    <script>
        $(document).ready(function() {
            ...
            let table = $('#datatable').DataTable({
                ...
                ajax: {
                    ...
                    url: '{{ route("dashboard-admin.master.certificate.index") }}',
                    type: 'GET',
        ...
        $("#formCreate").submit(function(e){
            ...
            $.ajax({
                ...
                url:"{{ route('dashboard-admin.master.certificate.store') }}",
        ...
        $("#formEdit").submit(function(e){
            ...
            $.ajax({
                ...
                url:"{{ route('dashboard-admin.master.certificate.index') }}/"+uuid,
