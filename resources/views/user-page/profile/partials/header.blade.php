        ...
        <div class="row align-items-start">
            ...
            <div class="col-lg-8">
                ...
                <div class="profile-avatar-wrapper">
                    ...
                    <img src="{{ $security->formal_photo ? Storage::url($security->formal_photo) : asset('assets/media/avatars/300-3.jpg') }}"
                ...
                @php
                    $badge = $security_certificates->firstWhere('is_badge', 1);
                @endphp
                ...
                @else
                    ...
                    <div class="profile-position text-muted">

                        <i class="ki-duotone ki-information-2 me-1"></i>

                        Belum memiliki sertifikasi utama
                ...
                <div class="profile-meta mt-4">
                    ...
                    <span>
                        ...
                        @if($security->province)

                            {{ $security->province }}, {{ $security->city }}
                    ...
                    <div id="profileBadgeContainer">

                        @if($badge)

                            <span class="badge-license">

                                <i class="ki-duotone ki-shield-tick me-1"></i>
                        ...
                        @else
                            ...
                            <span class="badge-license badge-license-empty">

                                <i class="ki-duotone ki-shield-cross me-1"></i>
