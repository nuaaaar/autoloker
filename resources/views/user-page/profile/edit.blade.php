    ...
    <div class="container-xxl">
        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-lg-8">
                @include('user-page.profile.partials.edit.stepper-header')
                <br>
                <div style="margin-bottom: 80px;">
                    <form method="POST" action="{{ route('user-page.profile.update-personal-data', $data->uuid) }}" enctype="multipart/form-data">
                        @csrf
                        @include('user-page.profile.partials.edit.step-1')
                        @include('user-page.profile.partials.edit.step-2')
                        @include('user-page.profile.partials.edit.step-3')
                        @include('user-page.profile.partials.edit.step-4')
                    </form>
                </div>
            </div>
