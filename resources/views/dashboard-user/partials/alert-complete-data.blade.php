    ...
    <div class="d-flex">
        ...
        <div class="flex-grow-1 ms-5">
            ...
            <div class="profile-alert-desc mt-3">
                ...
                Lengkapi informasi perusahaan agar profil Anda terlihat
                <b>lebih profesional</b>, meningkatkan
                <b>kepercayaan kandidat</b>, serta memudahkan proses
                <b>publikasi lowongan</b> dan <b>rekrutmen satpam</b>.
            ...
            <a href="javascript:;" class="profile-alert-detail">
                ...
                Lihat {{ $profile_progress['total'] - $profile_progress['completed'] }} informasi yang belum dilengkapi
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <a href="{{ route('dashboard-user.profile.edit-personal-data') }}">
                        ...
                        <button class="btn-profile-complete w-100">
                            ...
                            <i class="ki-duotone ki-office-bag fs-5 me-1 text-white"></i>
