                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-7">
                            ...
                            <div class="poster-upload-card">
                                ...
                                <div
                                    id="posterPreview"
                                    class="poster-preview {{ $data->poster ? '' : 'd-none' }}">

                                    <img
                                        id="posterPreviewImage"
                                        src="{{ $data->poster
                                            ? asset('storage/' . $data->poster)
                                            : '' }}"
                                ...
                                <label
                                    for="posterInput"
                                    id="posterUploadArea"
                                    class="poster-upload-area {{ $data->poster ? 'd-none' : '' }}">
                                ...
                                <div class="text-muted fs-7 mt-3">
                                    ...
                                    Gunakan poster dengan rasio
                                    <strong>3:4</strong>,
                                    ukuran minimal
                                    <strong>750 × 1000 px</strong>,
                                    format
                        ...
                        <div class="col-md-6 mb-7">
                            ...
                            <input
                                ...
                                name="provider"
                                value="{{ $data->provider }}"
                                placeholder="Contoh : PT ABC Training Center" readonly>
                        ...
                        <div class="col-md-6 mb-7">
                            ...
                            <select
                                ...
                                @foreach($masterCategoryCertificates as $certificate)
                                    <option value="{{ $certificate->title }}" {{ $data->category == $certificate->title ? 'selected' : '' }}>{{ $certificate->title }}</option>
                                @endforeach
                        ...
                        <div class="col-md-6 mb-7">
                            ...
                            <select
                                ...
                                <option value="Lanjutan" {{ $data->level == 'Lanjutan' ? 'selected' : '' }}>Lanjutan</option>
                                <option value="Profesional" {{ $data->level == 'Profesional' ? 'selected' : '' }}>Profesional</option>
                        ...
                        <div
                            ...
                            <input
                                ...
                                name="price"
                                value="{{ number_format((int)$data->price,0,',','.') }}"
                        ...
                        <div class="col-md-12 mb-7">
                            ...
                            <textarea
                                ...
                                class="form-control form-control-dark"
                                name="description"
                                placeholder="Jelaskan tujuan, manfaat, materi utama, target peserta, serta informasi penting mengenai pelatihan.">{{ $data->description }}</textarea>
                        ...
                        <div class="col-md-4 mb-7">
                            ...
                            <input
                                class="form-control form-control-dark"
                                value="{{ number_format($data->total_clicked) }} Kali"
                                disabled>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-8">
                            ...
                            <div class="option-group">
                                ...
                                <label class="option-card {{ $data->training_mode=='offline'?'active':'' }}">
                                    <input
                                        type="radio"
                                        name="training_mode"
                                        value="offline"
                                        {{ $data->training_mode=='offline'?'checked':'' }}>
                                    Offline
                                </label>

                                <label class="option-card {{ $data->training_mode=='online'?'active':'' }}">
                                    <input
                                        type="radio"
                                        name="training_mode"
                                        value="online"
                                        {{ $data->training_mode=='online'?'checked':'' }}>
                                    Online
                                </label>

                                <label class="option-card {{ $data->training_mode=='hybrid'?'active':'' }}">
                                    <input
                                        type="radio"
                                        name="training_mode"
                                        value="hybrid"
                                        {{ $data->training_mode=='hybrid'?'checked':'' }}>
                                    Hybrid
                                </label>
                        ...
                        <div class="col-md-12 mb-7">
                            ...
                            <textarea
                                name="address"
                                rows="6"
                                class="form-control form-control-dark">{{ $data->address }}</textarea>
                        ...
                        <div class="col-md-12 mb-7">
                            ...
                            <div class="job-builder">
                                ...
                                <input
                                    ...
                                    name="syllabus"
                                    id="syllabusJson"
                                    value='@json(json_decode($data->syllabus,true) ?? [])'>
                        ...
                        <div class="col-md-12 mb-7">
                            ...
                            <div class="job-builder mt-10">
                                ...
                                <input
                                    ...
                                    name="requirements"
                                    id="requirementJson"
                                    value='@json(json_decode($data->requirements,true) ?? [])'>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-8">
                            ...
                            <div class="option-group">
                                ...
                                <label class="option-card {{ $data->is_certificate ? 'active' : '' }}">

                                    <input
                                        type="radio"
                                        name="is_certificate"
                                        value="1"
                                        {{ $data->is_certificate ? 'checked' : '' }}>
                        ...
                        <div id="certificateArea">
                            ...
                            <div class="col-lg-6 mb-7">
                                ...
                                <select
                                    ...
                                    <option value=""
                                        {{ $data->certificate_validity=='' ? 'selected':'' }}>
                                        Tidak Ditentukan
                                    </option>

                                    <option value="Seumur Hidup"
                                        {{ $data->certificate_validity=='Seumur Hidup' ? 'selected':'' }}>
                                        Seumur Hidup
                                    </option>

                                    <option value="1 Tahun"
                                        {{ $data->certificate_validity=='1 Tahun' ? 'selected':'' }}>
                                        1 Tahun
                                    </option>

                                    <option value="2 Tahun"
                                        {{ $data->certificate_validity=='2 Tahun' ? 'selected':'' }}>
                                        2 Tahun
                                    </option>

                                    <option value="3 Tahun"
                                        {{ $data->certificate_validity=='3 Tahun' ? 'selected':'' }}>
                                        3 Tahun
                                    </option>

                                    <option value="5 Tahun"
                                        {{ $data->certificate_validity=='5 Tahun' ? 'selected':'' }}>
                                        5 Tahun
                                    </option>
                        ...
                        {{-- <div class="col-lg-12 mt-8">
                            ...
                            <input
                                ...
                                value='@json(json_decode($data->certificate_requirement,true) ?? [])'>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <div id="summaryTitle" class="text-muted">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <div id="summaryProvider" class="text-muted">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <div id="summaryLocation" class="text-muted">

                                                @if($data->training_mode=='online')

                                                    Online

                                                @elseif($data->training_mode=='hybrid')

                                                    {{ $data->city }}, {{ $data->province }} + Online
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <div id="summaryPeriod" class="text-muted">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <div id="summaryQuota" class="text-muted">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <div id="summaryCertificate" class="text-muted">

                                                {{ $data->is_certificate ? $data->certificate_name : 'Tidak Ada Sertifikat' }}
...
@section('js')
    <script>
        ...
        let tagItems = @json(json_decode($data->tags,true) ?? []);
        ...
        let syllabusItems = @json(json_decode($data->syllabus, true) ?? []);
        ...
        let requirementItems = @json(json_decode($data->requirements, true) ?? []);
        ...
        $(function () {
            ...
            function submitTraining(status){
                ...
                $.ajax({
                    ...
                    url: "{{ route('dashboard-user.training.update', $data->uuid) }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
                ...
                */
                ...
                if (!allowedTypes.includes(file.type)) {
                    ...
                    $('#posterError')
                        .removeClass('d-none')
                        .text(
                            'Format poster harus JPG, JPEG, atau PNG.'
                        );
            ...
            */
            ...
            $('#btnRemovePoster').on('click', function () {
                ...
                */
                ...
                /*
                | Tandai poster lama untuk dihapus
                */
