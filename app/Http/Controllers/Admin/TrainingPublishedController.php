...
class TrainingPublishedController extends Controller
{
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $data = Training::with('bujp', 'company')->where('status', 'published')
        ...
        return view('dashboard-admin.training.published.index');
    }
}
