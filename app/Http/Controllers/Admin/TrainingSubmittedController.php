...
class TrainingSubmittedController extends Controller
{
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $data = Training::with('bujp', 'company')->where('status', 'submitted')
        ...
        return view('dashboard-admin.training.submitted.index');
    }
}
