...
class TrainingRunningController extends Controller
{
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $data = Training::with('bujp', 'company')->where('status', 'running')
        ...
        return view('dashboard-admin.training.running.index');
    }
}
