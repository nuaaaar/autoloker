...
class TrainingRejectedController extends Controller
{
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $data = Training::with('bujp', 'company')->where('status', 'rejected')
        ...
        return view('dashboard-admin.training.rejected.index');
    }
}
