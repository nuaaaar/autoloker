...
class MasterPositionController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            //get data
            $data = MasterPosition::when($searchValue, function($q) use($searchValue) {
        ...
        return view('dashboard-admin.master.position.index');
    }
    ...
    public function update(Request $request, $uuid)
    {
        ...
        $data = MasterPosition::where('uuid',$uuid)->firstOrFail();
    ...
    {
        $data = MasterPosition::where('uuid', $id)->first();
