...
class CompanyController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            //get data
            $data = Company::when($searchValue, function($q) use($searchValue) {
        ...
        return view('dashboard-admin.management-user.company.index');
    }
    ...
    {
        $data['profile'] = Company::where('uuid', $id)->firstOrFail();

        $data['profileProgress'] = $data['profile']->profileProgress();

        return view('dashboard-admin.management-user.company.show', $data);
    }
